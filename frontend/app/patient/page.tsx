...
import { Calendar, VideoIcon, TrendingUp, MessageSquare } from "lucide-react"
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            >
              Bem-vindo(a) à sua área de paciente
            </motion.p>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-4 text-center md:text-left">
                ...
                <p className="text-white/70 max-w-md">
                  Conecte-se com seu especialista através de uma consulta virtual segura e de alta qualidade.
                </p>
              </div>
          ...
          <Link href="/patient/dashboard" className="group">
            <Card className="bg-white/5 border-white/10 h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                ...
                <p className="text-white/60 text-sm mt-2">Visualize seu resumo de saúde</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/patient/appointments" className="group">
            <Card className="bg-white/5 border-white/10 h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                ...
                <h3 className="text-lg font-medium text-white">Consultas</h3>
                <p className="text-white/60 text-sm mt-2">Gerencie seus agendamentos</p>
              </CardContent>
            </Card>
          </Link>

          <Link href="/patient/teleconsult" className="group">
            <Card className="bg-white/5 border-white/10 h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                <div className="p-3 bg-white/5 rounded-full mb-4 group-hover:bg-white/10 transition-all duration-300">
                ...
                <p className="text-white/60 text-sm mt-2">Consultas online com especialistas</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/patient/messages" className="group">
            <Card className="bg-white/5 border-white/10 h-full transition-all duration-300 hover:bg-white/10 hover:border-white/20">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                ...
                <h3 className="text-lg font-medium text-white">Mensagens</h3>
                <p className="text-white/60 text-sm mt-2">Comunique-se com sua equipe médica</p>
              </CardContent>
            </Card>
          </Link>
        </div>
